...
with tab9:
    ...
    if 'prices' in current:
        ...
        if selected_ticker and selected_ticker in prices.columns:
            ...
            macd, macd_signal_line, macd_hist = calculate_macd(ticker_prices)
            ...
            ax3.plot(macd_signal_line.index, macd_signal_line.values, label='Signal', color='red', linewidth=2)
